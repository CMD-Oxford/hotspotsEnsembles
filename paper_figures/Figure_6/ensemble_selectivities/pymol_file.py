...
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(-4.5, 10.5, 1.5), color=(1, 1, 1), label=18.6)

cmd.group("label_donor_hotspot", members="PS_donor_hotspot_0")
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_0")
cmd.pseudoatom(object="PS_acceptor_hotspot_0", pos=(-4.5, 8.0, 3.0), color=(1, 1, 1), label=17.6)

cmd.pseudoatom(object="PS_acceptor_hotspot_1", pos=(-7.0, 7.0, 3.0), color=(1, 1, 1), label=16.3)

cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(-5.5, 14.0, 1.0), color=(1, 1, 1), label=15.6)
...
cmd.group("label_acceptor_hotspot", members="PS_acceptor_hotspot_2")
cmd.pseudoatom(object="PS_apolar_hotspot_0", pos=(-9.5, 12.0, 3.0), color=(1, 1, 1), label=15.4)

cmd.pseudoatom(object="PS_apolar_hotspot_1", pos=(-6.5, 15.0, 0.5), color=(1, 1, 1), label=14.8)

cmd.pseudoatom(object="PS_apolar_hotspot_2", pos=(-3.5, 9.5, 2.5), color=(1, 1, 1), label=11.7)
...
surface_max_list = {'hotspot': {'fhm': 18.6}}
