...
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(0.5, 17.5, 47.0), color=(1, 1, 1), label=15.7)

cmd.pseudoatom(object="PS_donor_hotspot_1", pos=(1.0, 22.0, 42.0), color=(1, 1, 1), label=14.9)

cmd.pseudoatom(object="PS_donor_hotspot_2", pos=(5.5, 22.5, 36.5), color=(1, 1, 1), label=14.8)

cmd.pseudoatom(object="PS_donor_hotspot_3", pos=(-1.5, 16.5, 40.0), color=(1, 1, 1), label=12.0)

cmd.pseudoatom(object="PS_donor_hotspot_4", pos=(-1.5, 14.0, 40.5), color=(1, 1, 1), label=11.8)

cmd.pseudoatom(object="PS_donor_hotspot_5", pos=(-2.5, 28.0, 47.5), color=(1, 1, 1), label=8.7)
...
cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(5.5, 26.0, 39.0), color=(1, 1, 1), label=11.3)
...
cmd.pseudoatom(object="PS_apolar_hotspot_6", pos=(6.0, 16.5, 38.5), color=(1, 1, 1), label=13.2)

cmd.pseudoatom(object="PS_apolar_hotspot_7", pos=(8.5, 15.5, 35.0), color=(1, 1, 1), label=13.0)

cmd.pseudoatom(object="PS_apolar_hotspot_8", pos=(6.0, 17.0, 34.0), color=(1, 1, 1), label=12.8)

cmd.pseudoatom(object="PS_apolar_hotspot_9", pos=(8.5, 13.0, 34.0), color=(1, 1, 1), label=10.8)

cmd.pseudoatom(object="PS_apolar_hotspot_10", pos=(4.0, 13.5, 34.0), color=(1, 1, 1), label=12.4)

cmd.pseudoatom(object="PS_apolar_hotspot_11", pos=(6.0, 14.5, 34.0), color=(1, 1, 1), label=12.1)

cmd.pseudoatom(object="PS_apolar_hotspot_12", pos=(5.0, 15.5, 37.0), color=(1, 1, 1), label=11.4)

cmd.pseudoatom(object="PS_apolar_hotspot_13", pos=(-1.5, 14.5, 42.5), color=(1, 1, 1), label=9.4)

cmd.pseudoatom(object="PS_apolar_hotspot_14", pos=(-3.0, 25.5, 48.5), color=(1, 1, 1), label=6.1)
