...
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(1.0, 22.0, 42.0), color=(1, 1, 1), label=14.4)

cmd.pseudoatom(object="PS_donor_hotspot_1", pos=(5.5, 22.5, 36.5), color=(1, 1, 1), label=13.5)

cmd.pseudoatom(object="PS_donor_hotspot_2", pos=(0.0, 17.5, 46.5), color=(1, 1, 1), label=12.1)

cmd.pseudoatom(object="PS_donor_hotspot_3", pos=(-1.5, 14.0, 40.5), color=(1, 1, 1), label=11.0)

cmd.pseudoatom(object="PS_donor_hotspot_4", pos=(-1.0, 16.0, 40.0), color=(1, 1, 1), label=10.9)

cmd.pseudoatom(object="PS_donor_hotspot_5", pos=(-2.5, 28.0, 47.5), color=(1, 1, 1), label=8.5)
...
cmd.pseudoatom(object="PS_acceptor_hotspot_1", pos=(6.0, 22.5, 37.5), color=(1, 1, 1), label=14.0)

cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(5.5, 26.0, 39.0), color=(1, 1, 1), label=9.5)
...
cmd.pseudoatom(object="PS_apolar_hotspot_5", pos=(4.0, 13.5, 34.0), color=(1, 1, 1), label=12.2)

cmd.pseudoatom(object="PS_apolar_hotspot_6", pos=(6.0, 17.0, 34.0), color=(1, 1, 1), label=11.9)

cmd.pseudoatom(object="PS_apolar_hotspot_7", pos=(5.0, 15.5, 34.5), color=(1, 1, 1), label=11.6)

cmd.pseudoatom(object="PS_apolar_hotspot_8", pos=(0.5, 15.5, 46.0), color=(1, 1, 1), label=10.5)

cmd.pseudoatom(object="PS_apolar_hotspot_9", pos=(1.0, 14.0, 45.5), color=(1, 1, 1), label=10.5)

cmd.pseudoatom(object="PS_apolar_hotspot_10", pos=(-2.0, 14.5, 44.5), color=(1, 1, 1), label=8.4)

cmd.pseudoatom(object="PS_apolar_hotspot_11", pos=(10.0, 13.0, 34.0), color=(1, 1, 1), label=6.3)

cmd.pseudoatom(object="PS_apolar_hotspot_12", pos=(10.0, 11.5, 35.0), color=(1, 1, 1), label=6.3)
