...
cmd.pseudoatom(object="PS_donor_hotspot_1", pos=(-5.0, 11.0, 1.0), color=(1, 1, 1), label=18.5)
...
cmd.pseudoatom(object="PS_acceptor_hotspot_3", pos=(-5.0, 14.5, 1.0), color=(1, 1, 1), label=15.6)

cmd.pseudoatom(object="PS_acceptor_hotspot_4", pos=(-6.5, 8.0, 6.5), color=(1, 1, 1), label=14.4)
