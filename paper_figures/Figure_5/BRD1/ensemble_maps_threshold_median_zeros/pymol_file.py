...
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(-10.0, 12.5, 0.5), color=(1, 1, 1), label=23.6)

cmd.pseudoatom(object="PS_donor_hotspot_1", pos=(-5.5, 7.5, 4.0), color=(1, 1, 1), label=18.4)

cmd.pseudoatom(object="PS_donor_hotspot_2", pos=(-4.5, 11.0, 1.0), color=(1, 1, 1), label=18.0)
...
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_2")
cmd.pseudoatom(object="PS_acceptor_hotspot_0", pos=(-9.5, 11.0, 1.5), color=(1, 1, 1), label=21.5)

cmd.pseudoatom(object="PS_acceptor_hotspot_1", pos=(-4.5, 8.0, 3.0), color=(1, 1, 1), label=17.6)

cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(-7.0, 7.5, 3.0), color=(1, 1, 1), label=15.5)

cmd.pseudoatom(object="PS_acceptor_hotspot_3", pos=(-5.0, 14.5, 1.0), color=(1, 1, 1), label=15.3)

cmd.pseudoatom(object="PS_acceptor_hotspot_4", pos=(-6.5, 8.0, 6.5), color=(1, 1, 1), label=14.3)
...
surface_max_list = {'hotspot': {'fhm': 23.6}}
