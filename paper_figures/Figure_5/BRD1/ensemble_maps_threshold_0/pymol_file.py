...
cmd.pseudoatom(object="PS_donor_hotspot_1", pos=(-6.5, 15.0, 0.0), color=(1, 1, 1), label=19.7)

cmd.pseudoatom(object="PS_donor_hotspot_2", pos=(-4.5, 10.5, 1.0), color=(1, 1, 1), label=19.3)

cmd.pseudoatom(object="PS_donor_hotspot_3", pos=(-5.5, 7.5, 4.0), color=(1, 1, 1), label=18.4)

cmd.pseudoatom(object="PS_donor_hotspot_4", pos=(-8.0, 8.5, 1.5), color=(1, 1, 1), label=18.0)

cmd.pseudoatom(object="PS_donor_hotspot_5", pos=(-3.0, 14.0, -2.0), color=(1, 1, 1), label=15.4)

cmd.pseudoatom(object="PS_donor_hotspot_6", pos=(-0.5, 12.0, -1.0), color=(1, 1, 1), label=11.0)

cmd.pseudoatom(object="PS_donor_hotspot_7", pos=(-4.5, 3.0, -4.5), color=(1, 1, 1), label=10.9)

cmd.pseudoatom(object="PS_donor_hotspot_8", pos=(-1.0, 15.0, 1.5), color=(1, 1, 1), label=7.9)
...
cmd.pseudoatom(object="PS_acceptor_hotspot_1", pos=(-10.0, 9.0, 4.0), color=(1, 1, 1), label=19.8)

cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(-4.5, 8.0, 3.0), color=(1, 1, 1), label=17.6)

cmd.pseudoatom(object="PS_acceptor_hotspot_3", pos=(-6.0, 14.0, -1.5), color=(1, 1, 1), label=17.3)

cmd.pseudoatom(object="PS_acceptor_hotspot_4", pos=(-9.5, 13.0, 3.0), color=(1, 1, 1), label=17.1)

cmd.pseudoatom(object="PS_acceptor_hotspot_5", pos=(8.0, -13.0, 11.5), color=(1, 1, 1), label=17.1)

cmd.pseudoatom(object="PS_acceptor_hotspot_6", pos=(-5.5, 11.0, -2.0), color=(1, 1, 1), label=16.9)

cmd.pseudoatom(object="PS_acceptor_hotspot_7", pos=(-5.5, 13.0, 1.0), color=(1, 1, 1), label=16.5)

cmd.pseudoatom(object="PS_acceptor_hotspot_8", pos=(-7.0, 7.0, 3.0), color=(1, 1, 1), label=16.3)

cmd.pseudoatom(object="PS_acceptor_hotspot_9", pos=(-6.5, 8.0, 7.0), color=(1, 1, 1), label=15.3)

cmd.pseudoatom(object="PS_acceptor_hotspot_10", pos=(-5.5, 2.0, -4.5), color=(1, 1, 1), label=12.6)

cmd.pseudoatom(object="PS_acceptor_hotspot_11", pos=(-1.5, 10.5, 1.0), color=(1, 1, 1), label=7.2)
...
cmd.pseudoatom(object="PS_apolar_hotspot_3", pos=(-5.0, 2.0, -3.0), color=(1, 1, 1), label=9.4)

cmd.pseudoatom(object="PS_apolar_hotspot_4", pos=(-5.0, 5.0, -4.5), color=(1, 1, 1), label=6.5)
