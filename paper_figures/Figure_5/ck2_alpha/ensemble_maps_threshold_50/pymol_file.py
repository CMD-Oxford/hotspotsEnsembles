...
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(-1.0, 18.0, 45.5), color=(1, 1, 1), label=17.9)

cmd.pseudoatom(object="PS_donor_hotspot_1", pos=(2.0, 13.5, 35.0), color=(1, 1, 1), label=16.8)

cmd.pseudoatom(object="PS_donor_hotspot_2", pos=(0.5, 14.5, 37.5), color=(1, 1, 1), label=15.2)

cmd.pseudoatom(object="PS_donor_hotspot_3", pos=(6.0, 14.5, 35.5), color=(1, 1, 1), label=13.9)

cmd.pseudoatom(object="PS_donor_hotspot_4", pos=(2.5, 11.5, 31.0), color=(1, 1, 1), label=13.1)

cmd.pseudoatom(object="PS_donor_hotspot_5", pos=(5.5, 14.0, 33.0), color=(1, 1, 1), label=13.0)
...
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_5")
cmd.pseudoatom(object="PS_acceptor_hotspot_0", pos=(2.5, 20.5, 38.0), color=(1, 1, 1), label=18.2)

cmd.pseudoatom(object="PS_acceptor_hotspot_1", pos=(0.5, 19.5, 42.5), color=(1, 1, 1), label=18.2)

cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(2.5, 10.5, 31.5), color=(1, 1, 1), label=11.6)

cmd.pseudoatom(object="PS_acceptor_hotspot_3", pos=(7.0, 13.5, 35.5), color=(1, 1, 1), label=10.8)

cmd.pseudoatom(object="PS_acceptor_hotspot_4", pos=(-5.0, 9.5, 34.0), color=(1, 1, 1), label=10.7)
...
cmd.pseudoatom(object="PS_apolar_hotspot_2", pos=(5.0, 11.5, 31.5), color=(1, 1, 1), label=13.9)

cmd.pseudoatom(object="PS_apolar_hotspot_3", pos=(-6.0, 7.5, 33.5), color=(1, 1, 1), label=12.6)
