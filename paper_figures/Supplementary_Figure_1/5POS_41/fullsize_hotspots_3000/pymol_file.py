...
cmd.pseudoatom(object="PS_apolar_hotspot_4", pos=(9.5, -13.5, 12.799999999999997), color=(1, 1, 1), label=14.2)

cmd.pseudoatom(object="PS_apolar_hotspot_5", pos=(9.5, -12.5, 15.5), color=(1, 1, 1), label=17.2)

cmd.pseudoatom(object="PS_apolar_hotspot_6", pos=(11.0, -14.0, 12.0), color=(1, 1, 1), label=17.2)

cmd.pseudoatom(object="PS_apolar_hotspot_7", pos=(11.0, -14.5, 9.5), color=(1, 1, 1), label=16.5)
...
cmd.pseudoatom(object="PS_donor_hotspot_3", pos=(9.5, -13.0, 16.0), color=(1, 1, 1), label=15.6)

cmd.pseudoatom(object="PS_donor_hotspot_4", pos=(12.0, -15.5, 16.0), color=(1, 1, 1), label=12.5)
