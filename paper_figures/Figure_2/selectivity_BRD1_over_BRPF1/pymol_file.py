...
cmd.pseudoatom(object="PS_acceptor_hotspot_0", pos=(-4.5, 7.0, 3.5), color=(1, 1, 1), label=17.4)

cmd.pseudoatom(object="PS_acceptor_hotspot_1", pos=(8.0, -13.0, 11.5), color=(1, 1, 1), label=17.1)

cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(-7.0, 7.0, 3.0), color=(1, 1, 1), label=16.3)

cmd.pseudoatom(object="PS_acceptor_hotspot_3", pos=(-5.5, 14.0, 1.0), color=(1, 1, 1), label=15.6)
...
cmd.group("label_acceptor_hotspot", members="PS_acceptor_hotspot_3")
cmd.pseudoatom(object="PS_apolar_hotspot_0", pos=(-3.5, 9.5, 2.5), color=(1, 1, 1), label=11.7)
...
surface_max_list = {'hotspot': {'fhm': 17.4}}
